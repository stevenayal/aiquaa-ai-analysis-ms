#!/usr/bin/env python3
"""
Test simple para debuggear el template de Confluence
"""
...
def test_template():
    ...
    try:
        ...
        jira_data = {
            "key": "PROJ-123",
            "summary": "Implementar autenticacion de usuarios",
            "description": "El sistema debe permitir a los usuarios autenticarse",
            "issue_type": "Story",
            "priority": "High"
        }
        
        test_plan_title = "Plan de Pruebas - Autenticacion de Usuarios"
        ...
        if "{" in prompt and "}" in prompt:
            print("Advertencia: Posibles variables sin reemplazar en el prompt")
